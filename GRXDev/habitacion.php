...
<div class="container" id="main">
    <div class="row">
		...
		$id = isset($_GET['ID_Habitacion']) ? $_GET['ID_Habitacion'] : null;

		$result = $datos->Query("SELECT * FROM habitacion WHERE ID=".$id);
      ...
      <div class="col-md-12 col-sm-12">
    	<div class="panel panel-default">
           <div class="panel-heading"><a href="#" class="pull-right">View all</a> <h4>Habitacion<?php //echo $fila2['Nombre']?></h4></div>
			  ...
			  <img alt="imagen-habitacion" src="./images/a_prueba.jpg" class="img-responsive img-thumbnail pull-center" style="margin-left:35%; width:30%; height:30%;">
			  <hr>
			  <h5>Caracteristicas<h5>
			  <?php
					
                    $result3=$datos->Query("SELECT ID_Caracteristica, Cantidad from caracteristicashabitacion where ID_Habitacion=".$id);
					
                    
                    while($fila=mysql_fetch_array($result3))
                    {
						$result2=$datos->Query("SELECT * FROM caracteristicas WHERE ID_Caracteristicas=".$fila['ID_Caracteristica']);
