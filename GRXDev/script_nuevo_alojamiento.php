...
if(isset($_POST['add_nombre']) && isset($_POST['add_direccion']) && isset($_POST['add_tipo']) && isset($_POST['add_descripcion']) && isset($_COOKIE['id_usuario'])) {
    ...
    if (move_uploaded_file($_FILES['uploadedfile']['tmp_name'], $target_path)) {
        $ruta = 'images/alojamientos/' . basename($_FILES['uploadedfile']['name']);

        $cadena = "INSERT INTO alojamiento (Nombre,Direccion,Descripcion,Tipo_alojamiento,ID_Dueno,src_img) VALUES ('" . $_POST['add_nombre'] . "','" . $_POST['add_direccion'] . "','" . $_POST['add_descripcion'] . "','" . $_POST['add_tipo'] . "','" . $_COOKIE['id_usuario'] . "','".$ruta."')";
