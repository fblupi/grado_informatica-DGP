                ...
                if ($select) {
                    ...
                    if ($row[0] == 0) {
                        ...
                        if ($result) {
                            ...
                            header('location: index.php?cat=buscador_alo&error_reserva=true');
                        }
                    } else {
                        header('location: index.php?cat=buscador_alo&error_fechas_ocupadas=true');
                    }
                } else {
                    header('location: index.php?cat=buscador_alo&error_select=true');
                }
            } else {
                header('location: index.php?cat=buscador_alo&error_fechas=true');
            }
        }
