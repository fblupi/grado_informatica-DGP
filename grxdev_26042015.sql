...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-04-2015 a las 19:21:01
...
`ID` int(10) NOT NULL,
  ...
  `ID¨_Validador` int(10) NOT NULL,
  `Fecha_¨validacion` int(10) NOT NULL
...
INSERT INTO `alojamiento` (`ID`, `Nombre`, `Direccion`, `Descripcion`, `precio`, `Tipo_alojamiento`, `ID_Dueño`, `Fecha_alta`, `ID¨_Validador`, `Fecha_¨validacion`) VALUES
(1, 'Hotel Prado', 'Calle de prueba n3', 'Esto es un hotel de prueba para comprobar el funcionamiento de la web', 180, 1, 9, 26042015, 0, 26042015),
(2, 'Hotel Nes', 'Avnd los pajaritos n453', 'Otro alojamiento de prueba para comprobar el correcto funcionamiento de todo', NULL, 1, 9, 26042015, 1, 26042015),
(3, 'Pajaritos', 'Avd alondiga', 'Prueba de casa rural', NULL, 2, 9, 27042015, 0, 28042015),
(4, 'Pajaritos2', 'Avd alondiga', 'Prueba de casa rural', NULL, 2, 9, 26042015, 0, 27042015);
